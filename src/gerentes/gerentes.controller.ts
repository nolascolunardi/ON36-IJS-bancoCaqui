...
export class GerentesController {
  ...
  createCliente(
    ...
    return this.GerentesService.createCliente(
      nome,
      cpf,
      email,
      telefone,
  ...
  createConta(
    ...
    return this.GerentesService.createConta(
      idCliente,
      numeroConta,
      tipoConta,
      saldo,
  ...
  @Patch('/clientes/alterarConta/:idCliente')
  updateTipoConta(
  ...
  @Delete('/clientes/deletarConta/:idCliente')
